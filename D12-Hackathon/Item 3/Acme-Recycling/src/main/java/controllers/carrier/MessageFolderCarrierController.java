...
@Controller
@RequestMapping("/messageFolder/carrier")
public class MessageFolderCarrierController extends AbstractController{
	...
	public MessageFolderCarrierController() {
		super();
	}
	...
	public ModelAndView list() {
		...
		Assert.isTrue(principal instanceof Carrier);

		result = new ModelAndView("messageFolder/list");
		result.addObject("messageFolders", messageFolders);
		result.addObject("requestURI", "messageFolder/carrier/list.do");
		result.addObject("RequestURIedit", "messageFolder/carrier/edit.do");
		result.addObject("RequestURImessages", "message/carrier/list.do?d-16544-p=1");
	...
	protected ModelAndView createEditModelAndView(MessageFolder messageFolder, String messageCode) {
		...
		result.addObject("requestURI", "messageFolder/carrier/edit.do");
