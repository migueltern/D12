...
<display:table name="carrier" class="displaytag"
  ...
  <!-- Attributes -->
	...
	<p>
		<B><spring:message code="carrier.phoneNumber" />:</B>
		<jstl:out value="${row.phone}"></jstl:out>
	</p>
	<p>
		<B><spring:message code="carrier.emailAddress" />:</B>
		<jstl:out value="${row.email}"></jstl:out>
	</p>
		<p>
		<B><spring:message code="carrier.postalAddress" />:</B>
		<jstl:out value="${row.address}"></jstl:out>
	</p>
	<p>
		<B><spring:message code="carrier.province" />:</B>
