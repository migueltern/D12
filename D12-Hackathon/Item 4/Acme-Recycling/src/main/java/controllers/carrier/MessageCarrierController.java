...
@Controller
@RequestMapping("/message/carrier")
public class MessageCarrierController extends AbstractController{
...
//	Services --------------------------------------------------------
	...
	public MessageCarrierController(){
		super();
	}
	...
	public ModelAndView list(@RequestParam int messageFolderId) {
		...
		result.addObject("RequestURIChange", "message/carrier/changeFolder.do");
		result.addObject("RequestURIDisplay", "message/carrier/display.do");
		result.addObject("requestURI", "message/carrier/list.do");
	...
	public ModelAndView display(@RequestParam int messageId) {
		...
		result.addObject("RequestURIreply", "message/carrier/reply.do");
		result.addObject("requestURI", "message/carrier/display.do");
	...
	public ModelAndView create() {
		...
		result.addObject("requestURI", "message/carrier/send.do");
	...
	public ModelAndView reply(@RequestParam int messageId) {
		...
		result.addObject("requestURI", "message/carrier/reply.do");
	...
	public ModelAndView changeFolderMessage(@RequestParam int messageId) {
		...
		result.addObject("requestURICancel", "message/carrier/list.do?messageFolderId=" + message.getMessageFolder().getId());
	...
	public ModelAndView changeFolderMessage(@ModelAttribute("m") Message m, BindingResult binding, @RequestParam int messageId) {
		...
		if (binding.hasErrors())
			...
			try {
				...
				result = new ModelAndView("redirect:/messageFolder/carrier/list.do");
			} catch (Throwable oops) {
	...
	protected ModelAndView createNewModelAndView(Message m, String message) {
		...
		result.addObject("show", true);
		result.addObject("RequestURICancel", "messageFolder/carrier/list.do");
	...
	protected ModelAndView createNewModelAndViewChange(Message m, String message) {
		...
		result = new ModelAndView("message/changeFolder");
		result.addObject("folders", messageFolders);
		result.addObject("requestURICancel", "message/carrier/list.do?messageFolderId=" + m.getMessageFolder().getId());
