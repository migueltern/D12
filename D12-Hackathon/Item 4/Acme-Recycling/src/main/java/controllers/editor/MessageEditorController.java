...
@Controller
@RequestMapping("/message/editor")
public class MessageEditorController extends AbstractController{
...
//	Services --------------------------------------------------------
	...
	public ModelAndView list(@RequestParam int messageFolderId) {
		...
		result.addObject("RequestURIChange", "message/editor/changeFolder.do");
		result.addObject("RequestURIDisplay", "message/editor/display.do");
		result.addObject("requestURI", "message/editor/list.do");
	...
	public ModelAndView display(@RequestParam int messageId) {
		...
		result.addObject("RequestURIreply", "message/editor/reply.do");
		result.addObject("requestURI", "message/editor/display.do");
	...
	public ModelAndView create() {
		...
		result.addObject("requestURI", "message/editor/send.do");
	...
	public ModelAndView reply(@RequestParam int messageId) {
		...
		result.addObject("requestURI", "message/editor/reply.do");
	...
	public ModelAndView changeFolderMessage(@RequestParam int messageId) {
		...
		result.addObject("requestURICancel", "message/editor/list.do?messageFolderId=" + message.getMessageFolder().getId());
	...
	public ModelAndView changeFolderMessage(@ModelAttribute("m") Message m, BindingResult binding, @RequestParam int messageId) {
		...
		if (binding.hasErrors())
			...
			try {
				...
				result = new ModelAndView("redirect:/messageFolder/editor/list.do");
			} catch (Throwable oops) {
	...
	protected ModelAndView createNewModelAndView(Message m, String message) {
		...
		result.addObject("show", true);
		result.addObject("RequestURICancel", "messageFolder/editor/list.do");
	...
	protected ModelAndView createNewModelAndViewChange(Message m, String message) {
		...
		result = new ModelAndView("message/changeFolder");
		result.addObject("folders", messageFolders);
		result.addObject("requestURICancel", "message/editor/list.do?messageFolderId=" + m.getMessageFolder().getId());
