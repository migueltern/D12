...
@Controller
@RequestMapping("/messageFolder/editor")
public class MessageFolderEditorController extends AbstractController{
...
//	Services --------------------------------------------------------
	...
	public MessageFolderEditorController() {
		super();
	}
	...
	public ModelAndView list() {
		...
		Assert.isTrue(principal instanceof Editor);

		result = new ModelAndView("messageFolder/list");
		result.addObject("messageFolders", messageFolders);
		result.addObject("requestURI", "messageFolder/editor/list.do");
		result.addObject("RequestURIedit", "messageFolder/editor/edit.do");
		result.addObject("RequestURImessages", "message/editor/list.do?d-16544-p=1");
	...
	protected ModelAndView createEditModelAndView(MessageFolder messageFolder, String messageCode) {
		...
		result.addObject("requestURI", "messageFolder/editor/edit.do");
