...
public class MessageRecyclerController extends AbstractController{
	...
	public ModelAndView list(@RequestParam int messageFolderId) {
		...
		result.addObject("RequestURIDisplay", "message/recycler/display.do");
	...
	public ModelAndView display(@RequestParam int messageId) {
		...
		result.addObject("RequestURIreply", "message/recycler/reply.do");
		result.addObject("requestURI", "message/recycler/display.do");
	...
	public ModelAndView create() {
		...
		result.addObject("requestURI", "message/recycler/send.do");
	...
	public ModelAndView reply(@RequestParam int messageId) {
		...
		result.addObject("requestURI", "message/recycler/reply.do");
	...
	public ModelAndView changeFolderMessage(@RequestParam int messageId) {
		...
		result.addObject("requestURICancel", "message/recycler/list.do?messageFolderId=" + message.getMessageFolder().getId());
	...
	protected ModelAndView createNewModelAndViewChange(Message m, String message) {
		...
		result = new ModelAndView("message/changeFolder");
		result.addObject("folders", messageFolders);
		result.addObject("requestURICancel", "message/recycler/list.do?messageFolderId=" + m.getMessageFolder().getId());
