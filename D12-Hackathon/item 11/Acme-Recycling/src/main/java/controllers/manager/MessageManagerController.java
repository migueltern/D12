...
//	Services --------------------------------------------------------
	...
	public ModelAndView list(@RequestParam int messageFolderId) {
		...
		result.addObject("RequestURIChange", "message/manager/changeFolder.do");
		result.addObject("RequestURIDisplay", "message/manager/display.do");
	...
	public ModelAndView display(@RequestParam int messageId) {
		...
		result.addObject("RequestURIreply", "message/manager/reply.do");
		result.addObject("requestURI", "message/manager/display.do");
	...
	public ModelAndView reply(@RequestParam int messageId) {
		...
		result.addObject("requestURI", "message/manager/reply.do");
	...
	public ModelAndView changeFolderMessage(@RequestParam int messageId) {
		...
		result.addObject("requestURICancel", "message/manager/list.do?messageFolderId=" + message.getMessageFolder().getId());
	...
	protected ModelAndView createNewModelAndView(Message m, String message) {
		...
		result.addObject("show", true);
		result.addObject("RequestURICancel", "messageFolder/manager/list.do");
	...
	protected ModelAndView createNewModelAndViewChange(Message m, String message) {
		...
		result = new ModelAndView("message/changeFolder");
		result.addObject("folders", messageFolders);
		result.addObject("requestURICancel", "message/manager/list.do?messageFolderId=" + m.getMessageFolder().getId());
