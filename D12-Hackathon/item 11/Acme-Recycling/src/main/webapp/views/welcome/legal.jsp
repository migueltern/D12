...
ACME (EN ADELANTE EL PROPIETARIO) con domicilio a efectos de notificaciones en Sevilla con CIF BXXXXXXX pone a disposición en su sitio web  www.acme.com determinados  contenidos de carácter informativo sobre sus actividades.Las presentes condiciones generales rigen única y exclusivamente el uso del sitio web de EL PROPIETARIO por parte de los USUARIOS que accedan al mismo. Las presentes condiciones generales se le exponen al USUARIO en el sitio web www.acmebnb.com  en todas y cada una de las páginas, para que las lea, las imprima, archive y acepte a través de internet y se encuentre plenamente informado.
...
<strong>2.3.-</strong> EL PROPIETARIO se reserva el derecho a modificar en cualquier momento los contenidos existentes en su sitio web. EL PROPIETARIO no asegura ni se responsabiliza del correcto funcionamiento de los enlaces a sitios web de terceros que figuren en www.acmebnb.com</p>
